...
@Autonomous(name="Autonomous1New", group="Pushbot")
public class Autonomous1New extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (robot.sensorColor.blue() < robot.sensorColor.red()){
            ...
            robot.drivestraight(-100, 0.5);

            robot.robotsleep(0);
            sleep(300);

            robot.drivestrafe(16, 0.35);
