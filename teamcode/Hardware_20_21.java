...
public class Hardware_20_21 {
    ...
    */
    ...
    public void drivestraightsonicsensorOscar(double inches, double power,double distancefromwall) {
        ...
        while (rearLeftMotor.isBusy() && rearRightMotor.isBusy() && frontLeftMotor.isBusy() && frontRightMotor.isBusy() && opMode.opModeIsActive()) {
            ...
            if (distance<(distancefromwall-0.1)){
            ...
            if (Math.abs(rearLeftMotor.getTargetPosition() - rearLeftMotor.getCurrentPosition()) < (13 * (600 / 26))) {
    ...
    public void drivestraightsonicsensorOscarUGGG(double inches, double power,double distancefromwall) {
